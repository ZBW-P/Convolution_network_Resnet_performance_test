...
if __name__ == "__main__":
    ...
    num_grads = sum(p.grad.numel() for p in model.parameters() if p.grad is not None)
    print("Number of gradients:", num_grads)
    #python Q3.py --cuda --data_path ./data --num_workers 0 --batch_size 128 --optimizer sgd --epochs 5